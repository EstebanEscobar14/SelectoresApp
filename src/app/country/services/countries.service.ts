...
export class CountriesService {
  ...
  getBorderByCountryCode(countryCode: string): Observable<SmallCountry> {
  ...
  getCountryBordersByCodes(codes: string[]): Observable<SmallCountry[]> {
    ...
    codes.forEach(code => {
      countryRequests.push(this.getBorderByCountryCode(code));
    });
